...
VALUES
    ('hiragana-a', 'あ', 'a', '/audio/a.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 1),
    ('hiragana-i', 'い', 'i', '/audio/i.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 2),
    ('hiragana-u', 'う', 'u', '/audio/u.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 3),
    ('hiragana-e', 'え', 'e', '/audio/e.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 4),
    ('hiragana-o', 'お', 'o', '/audio/o.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 5),

    ('hiragana-ka', 'か', 'ka', '/audio/ka.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 6),
    ('hiragana-ki', 'き', 'ki', '/audio/ki.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 7),
    ('hiragana-ku', 'く', 'ku', '/audio/ku.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 8),
    ('hiragana-ke', 'け', 'ke', '/audio/ke.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 9),
    ('hiragana-ko', 'こ', 'ko', '/audio/ko.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 10),

    ('hiragana-sa', 'さ', 'sa', '/audio/sa.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 11),
    ('hiragana-si', 'し', 'si', '/audio/si.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 12),
    ('hiragana-su', 'す', 'su', '/audio/su.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 13),
    ('hiragana-se', 'せ', 'se', '/audio/se.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 14),
    ('hiragana-so', 'そ', 'so', '/audio/so.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 15),

    ('hiragana-ta', 'た', 'ta', '/audio/ta.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 16),
    ('hiragana-ti', 'ち', 'ti', '/audio/ti.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 17),
    ('hiragana-tu', 'つ', 'tu', '/audio/tu.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 18),
    ('hiragana-te', 'て', 'te', '/audio/te.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 19),
    ('hiragana-to', 'と', 'to', '/audio/to.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 20),

    ('hiragana-na', 'な', 'na', '/audio/na.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 21),
    ('hiragana-ni', 'に', 'ni', '/audio/ni.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 22),
    ('hiragana-nu', 'ぬ', 'nu', '/audio/nu.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 23),
    ('hiragana-ne', 'ね', 'ne', '/audio/ne.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 24),
    ('hiragana-no', 'の', 'no', '/audio/no.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 25),

    ('hiragana-ha', 'は', 'ha', '/audio/ha.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 26),
    ('hiragana-hi', 'ひ', 'hi', '/audio/hi.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 27),
    ('hiragana-hu', 'ふ', 'hu', '/audio/hu.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 28),
    ('hiragana-he', 'へ', 'he', '/audio/he.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 29),
    ('hiragana-ho', 'ほ', 'ho', '/audio/ho.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 30),

    ('hiragana-ma', 'ま', 'ma', '/audio/ma.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 31),
    ('hiragana-mi', 'み', 'mi', '/audio/mi.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 32),
    ('hiragana-mu', 'む', 'mu', '/audio/mu.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 33),
    ('hiragana-me', 'め', 'me', '/audio/me.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 34),
    ('hiragana-mo', 'も', 'mo', '/audio/mo.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 35),

    ('hiragana-ya', 'や', 'ya', '/audio/ya.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 36),
    ('hiragana-yu', 'ゆ', 'yu', '/audio/yu.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 38),
    ('hiragana-yo', 'よ', 'yo', '/audio/yo.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 40),

    ('hiragana-ra', 'ら', 'ra', '/audio/ra.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 41),
    ('hiragana-ri', 'り', 'ri', '/audio/ri.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 42),
    ('hiragana-ru', 'る', 'ru', '/audio/ru.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 43),
    ('hiragana-re', 'れ', 're', '/audio/re.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 44),
    ('hiragana-ro', 'ろ', 'ro', '/audio/ro.mp3', NULL, 'HIRAGANA', 'BASIC', 1, 45),
